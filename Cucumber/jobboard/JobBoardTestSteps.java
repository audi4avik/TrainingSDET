...
public class JobBoardTestSteps {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void adduserInfo() {
        ...
        driver.findElement(By.id("user_login")).sendKeys("avik_sdet");
        driver.findElement(By.id("email")).sendKeys("sdet@ymail.com");
    ...
    public void getJobDetails() {
        ...
        driver.findElement(By.xpath("(//h3[text()='Automation test Specialist'])[1]")).click();
    ...
    public void verifyPosting() {       
        ...
        String titleXpath = "//h1[contains(text(), 'SDET Automation 5+ years')]";
        ...
        Assert.assertEquals("SDET Automation 5+ years", postTitle);
